...
#
# 	drawBtn = QPushButton("绘制线条")
# 	# drawBtn.setStyleSheet("border: 1px solid blue;")
# 	pixmap = QPixmap("imgs/pen.png")
# 	drawBtn.setFixedSize(80, 40)
# 	drawBtn.setIcon(QIcon(pixmap))
# 	drawBtn.setStyleSheet("""
# 		QPushButton {
# 			background-color: #e3e3e3;
...
#
# 	stop_button = QPushButton("编辑文字")
# 	# stop_button.setStyleSheet("border: 1px solid blue;")
# 	stop_button.setFixedSize(80, 40)
# 	stop_button.setStyleSheet("""
# 		QPushButton {
# 			background-color: #e3e3e3;
# 			border-radius:5px;
...
#
# 	delete_btn = QPushButton("删除")
# 	# delete_btn.setStyleSheet("border: 1px solid blue;")
...
#
# 	self.buttons = [addBtn, drawBtn, stop_button, delete_btn]
#
# 	btnHbox.addWidget(addBtn)
# 	btnHbox.addWidget(drawBtn)
# 	btnHbox.addWidget(stop_button)
# 	btnHbox.addWidget(delete_btn)
...
# 	self.widgetLayout.addWidget(btnWidget)
#
# def initLineEditInput(self):
...
# 	vertical_label = QLabel("竖线长度调整")
# 	vertical_label.setContentsMargins(0, 0, 0, 0)
# 	vertical_label.setFixedSize(80, 30)
# 	vertical_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
# 	vertical_label.setStyleSheet("border:none")
# 	self.vertical_edit = QLineEdit()
# 	self.vertical_edit.setFixedSize(80, 30)
# 	vertical_layout.addWidget(vertical_label)
# 	vertical_layout.addWidget(self.vertical_edit)
# 	vertical_layout.setSpacing(5)
# 	left_layout.addLayout(vertical_layout)
...
# 	# 确认按钮
# 	vertical_btn = QPushButton()
# 	vertical_btn.setFixedSize(80, 30)
# 	vertical_btn.setText("确认")
# 	vertical_btn.clicked.connect(self.adjustVerticalLines)
# 	btnLayout.addWidget(vertical_btn)
# 	btnLayout.addStretch(1)
# 	left_layout.addLayout(btnLayout)
...
# 	horizontal_label.setFixedSize(80, 30)
# 	self.horizontal_edit = QLineEdit()
# 	self.horizontal_edit.setFixedSize(80, 30)
# 	horizontal_layout.addWidget(horizontal_label)
# 	horizontal_layout.addWidget(self.horizontal_edit)
# 	horizontal_layout.setSpacing(5)
# 	right_layout.addLayout(horizontal_layout)
...
# 	# 确认按钮
# 	horizontal_btn = QPushButton()
# 	horizontal_btn.setFixedSize(80, 30)
# 	horizontal_btn.setText("确认")
# 	horizontal_btn.clicked.connect(self.adjustHorizontalLines)
#
# 	btnLayout.addWidget(horizontal_btn)
# 	btnLayout.addStretch(1)
# 	right_layout.addLayout(btnLayout)
...
# 	# 添加到主布局中
# 	self.buttons.append(vertical_btn)
# 	self.buttons.append(horizontal_btn)
# 	self.widgetLayout.addLayout(main_layout)
#
# def initEditButtons(self):
# 	button_layout = QHBoxLayout()
# 	self.view_rect_btn = QPushButton("显示文字方框")
# 	self.view_rect_btn.setFixedSize(80, 30)
# 	self.view_rect_btn.setStyleSheet("border: 1px solid blue")
# 	self.view_rect_btn.clicked.connect(self.displayRect)
#
# 	standardize_btn = QPushButton()
# 	standardize_btn.setFixedSize(80, 30)
# 	standardize_btn.setText("标准化表格")
# 	standardize_btn.clicked.connect(self.standardizeLengthTable)
# 	# main_layout.addWidget(standardize_btn)
#
# 	transfer_btn = QPushButton()
# 	transfer_btn.setFixedSize(80, 30)
# 	transfer_btn.setText("图片预处理")
# 	transfer_btn.clicked.connect(self.imageTrans)
#
# 	help_btn = QPushButton()
# 	help_btn.setFixedSize(80, 30)
# 	help_btn.setText("帮助文档")
#
# 	button_layout.addWidget(self.view_rect_btn)
# 	button_layout.addWidget(standardize_btn)
# 	button_layout.addWidget(transfer_btn)
# 	button_layout.addWidget(help_btn)
# 	button_layout.setSpacing(10)
#
# 	self.buttons.append(self.view_rect_btn)
# 	self.buttons.append(standardize_btn)
#
...
# 	label.setText("表格格式转换")
# 	label.setStyleSheet("border: none")
#
# 	self.toggle_box = QCheckBox()
# 	self.toggle_box.setFixedSize(190, 30)
# 	self.toggle_box.setText("使用Microsoft Word转换接口")
# 	self.toggle_box.setStyleSheet("""
# 	    QCheckBox::indicator {
# 	        width: 16px;
# 	        height: 16px;
...
# 	title_layout.addWidget(self.toggle_box)
...
# 	space_btn.setText("线条特殊")
# 	space_btn.setFixedSize(80, 30)
# 	space_btn.clicked.connect(self.set_line_special)
#
# 	btn_layout.addWidget(word_btn)
# 	btn_layout.addWidget(pdf_btn)
# 	btn_layout.addWidget(html_btn)
...
# 	btn_layout.setSpacing(10)
#
# 	self.widgetLayout.addLayout(btn_layout)
#
# 	btn_layout = QHBoxLayout()
# 	self.btn_width_plus = QPushButton("宽度 +")
# 	self.btn_width_plus.setFixedSize(40, 30)
# 	self.width_label = QLineEdit()
# 	self.width_label.setFixedSize(20, 30)
# 	self.width_label.setText("5")
# 	self.width_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
# 	self.btn_width_minus = QPushButton("宽度 -")
# 	self.btn_width_minus.setFixedSize(40, 30)
#
# 	self.btn_height_plus = QPushButton("高度 +")
# 	self.height_label = QLineEdit()
# 	self.height_label.setFixedSize(20, 30)
# 	self.height_label.setText("5")
# 	self.height_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
# 	self.btn_height_plus.setFixedSize(40, 30)
# 	self.btn_height_minus = QPushButton("高度 -")
# 	self.btn_height_minus.setFixedSize(40, 30)
#
# 	# 连接按钮信号
# 	self.btn_width_plus.clicked.connect(lambda: self.adjust_rect_size_step("width", "+"))
# 	self.btn_width_minus.clicked.connect(lambda: self.adjust_rect_size_step("width", "-"))
# 	self.btn_height_plus.clicked.connect(lambda: self.adjust_rect_size_step("height", "+"))
# 	self.btn_height_minus.clicked.connect(lambda: self.adjust_rect_size_step("height", "-"))
#
# 	btn_layout.addWidget(self.btn_width_plus)
# 	btn_layout.addWidget(self.width_label)
# 	btn_layout.addWidget(self.btn_width_minus)
# 	btn_layout.addWidget(self.btn_height_plus)
# 	btn_layout.addWidget(self.height_label)
# 	btn_layout.addWidget(self.btn_height_minus)
# 	self.widgetLayout.addLayout(btn_layout)

# self.initToolButton()
# labelWidget 用来跟踪文本的容器
# labelWidget = QWidget()
...
# self.widgetLayout.addWidget(labelWidget)
# # adjust_layout是对矩形高度和宽度进行调整的整个布局  包括两输入框和一个按钮
# input_layout = QHBoxLayout()
#
# input_layout.addStretch(1)
# w_label = QLabel("宽度")
# w_label.setFixedSize(30, 26)
# w_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
# w_label.setStyleSheet("border:none")
# input_layout.addWidget(w_label)
# self.rect_width_text = QLineEdit()
# self.rect_width_text.setPlaceholderText("宽度输入框")
# self.rect_width_text.setFixedSize(100, 26)
# input_layout.addWidget(self.rect_width_text)
#
# input_layout.addStretch(1)
#
# h_label = QLabel("高度")
# h_label.setFixedSize(30, 26)
# h_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
# h_label.setStyleSheet("border:none")
# input_layout.addWidget(h_label)
# self.rect_height_text = QLineEdit()
# self.rect_height_text.setPlaceholderText("高度输入框")
# self.rect_height_text.setFixedSize(100, 26)
# input_layout.addWidget(self.rect_height_text)
#
# input_layout.addStretch(1)
# input_layout.setSpacing(5)
#
# adjustBtn = QPushButton("调整")
# adjustBtn.setFixedSize(120, 30)
# adjustBtn.setStyleSheet("""
# 	QPushButton {
# 		background-color: #54a9fd;
# 		border-radius:8px;
...
# """)
# adjustBtn.clicked.connect(self.adjustRectSize)
# input_layout.addWidget(adjustBtn)
# self.widgetLayout.addLayout(input_layout)
# self.initLineEditInput()
# # adjust_layout.addLayout(input_layout)
# # adjust_layout.addWidget(adjustBtn)
#
# save_layout = QHBoxLayout()
# # save_layout.addStretch(1)
# save_rect_btn = QPushButton("保存")
# save_rect_btn.setIcon(QIcon("imgs/save.png"))
# save_rect_btn.setStyleSheet("border: 1px solid blue")
# save_rect_btn.clicked.connect(self.saveAsFile)
# save_rect_btn.setFixedSize(80, 30)
#
# self.combox = QComboBox()
# self.combox.setPlaceholderText("选择保存文件格式")
# self.combox.addItem("word")
...
# self.combox.addItem("html")
# self.combox.setCurrentIndex(-1)
# self.combox.setFixedSize(190, 30)
#
# save_layout.addWidget(save_rect_btn)
# save_layout.addWidget(self.combox)
# save_layout.setSpacing(10)
# # adjust_layout.addWidget(edit_rect_btn)
# self.widgetLayout.addLayout(save_layout)
#
# # self.initEditButtons()
# self.convert_format()
#
# # main_layout.addWidget(transfer_btn)
# # adjust_layout.addWidget(self.view_rect_btn)
#
# # self.widgetLayout.addLayout(adjust_layout)
#
# self.widgetLayout.addStretch(1)
# self.right_widget.setLayout(self.widgetLayout)
